import { Box, Button, ButtonGroup, ListItemText, Paper, Typography } from "@mui/material";
...
const counter= observer(function Counter()  {
  ...
  return (
    <Box display='flex' justifyContent='space-between'>
      <Box sx={{width: '60%'}}>
      <Typography variant="h4" color="white" gutterBottom>{counterStore.title}</Typography>
      <Typography variant="h6" color="white"> The count is: {counterStore.count}</Typography>
    <ButtonGroup sx={{mt: 3}}>
